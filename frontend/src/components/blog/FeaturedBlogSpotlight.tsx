...
export default function FeaturedBlogSpotlight({
  ...
  return (
    <Link href={`/blog/${blog.id}`} className="group block">
      <article className="grid gap-6 overflow-hidden rounded-[32px] border border-stone-200 bg-white shadow-[0_24px_80px_-48px_rgba(41,37,36,0.45)] transition-shadow duration-300 group-hover:shadow-[0_24px_90px_-42px_rgba(41,37,36,0.3)] lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="flex flex-col justify-center gap-5 px-5 py-7 sm:px-8 lg:px-10">
          ...
          <div className="space-y-4">
            <h2 className="font-heading text-3xl font-bold leading-tight text-stone-900 transition-colors group-hover:text-amber-700 sm:text-4xl">
              {blog.title}
            </h2>
